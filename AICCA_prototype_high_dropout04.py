...
def train_model(training_checkpoint_path,**kwargs):
    trainer = pl.Trainer(default_root_dir=os.path.join(CHECKPOINT_PATH, "ViT_high_dropout04"),
    ...
    pretrained_filename = os.path.join(CHECKPOINT_PATH, "ViT_high_dropout04.ckpt")
...
training_checkpoint_path = "/home/tdmonkman/scratch-midway2/AICCA_proj/ViT_high_dropout04/lightning_logs/version_4/checkpoints/last.ckpt"
