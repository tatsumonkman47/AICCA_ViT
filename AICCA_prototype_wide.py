...
def train_model(training_checkpoint_path,**kwargs):
    trainer = pl.Trainer(default_root_dir=os.path.join(CHECKPOINT_PATH, "ViT_wide"),
    ...
    pretrained_filename = os.path.join(CHECKPOINT_PATH, "ViT_wide.ckpt")
...
########################################################################################################
########################################################################################################
training_checkpoint_path = "/home/tdmonkman/scratch-midway2/AICCA_proj/ViT_wide/lightning_logs/version_0/checkpoints/last.ckpt"
